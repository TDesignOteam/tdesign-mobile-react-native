...
description: TDesign 适配移动端的组件库，适合在 React Native 技术栈项目中使用。
spline: explain
---
...
```javascript
import { Button } from 'tdesign-react-native';
import 'tdesign-react-native/es/style/index.css'; // 少量公共样式
```

## 也提供不带样式引入

```javascript
import { Button } from 'tdesign-react-native/lib/';
import 'tdesign-react-native/dist/tdesign.css'; // 如需样式请添加这行
```
...
```javascript
import { Button } from 'tdesign-react-native/esm/';
import 'tdesign-react-native/esm/style/index.js'; // 少量公共样式
```
