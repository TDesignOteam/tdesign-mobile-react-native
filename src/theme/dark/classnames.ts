...
import { darkTokens as tokens } from './tokens';
...
export const classnames = {
  ...
  // ================  边框  ===================
  b0: { borderWidth: tokens.spacers.spacer0 },
  b1: {
    borderWidth: tokens.spacers.spacer1,
    borderStyle: 'solid',
    borderColor: tokens.colors.componentBorder,
  },
  bb1: {
    borderBottomWidth: tokens.spacers.spacer1,
    borderStyle: 'solid',
    borderColor: tokens.colors.componentBorder,
  },
  bt1: {
    borderTopWidth: tokens.spacers.spacer1,
    borderStyle: 'solid',
    borderColor: tokens.colors.componentBorder,
  },
  br1: {
    borderRightWidth: tokens.spacers.spacer1,
    borderStyle: 'solid',
    borderColor: tokens.colors.componentBorder,
  },
  bl1: {
    borderLeftWidth: tokens.spacers.spacer1,
    borderStyle: 'solid',
    borderColor: tokens.colors.componentBorder,
  },
